...
public class Home extends JFrame {
	...
	public Home() {
		...
		mainLabel.setFont(new Font("Arial Black", Font.PLAIN, 200));
		mainLabel.setBounds(172, 28, 283, 29);
		main.add(mainLabel);
		
		JLabel examLabel = new JLabel("Exam Name");
		examLabel.setFont(new Font("Arial", Font.PLAIN, 75));
		...
		stdNameLabel.setFont(new Font("Arial", Font.PLAIN, 75));
		...
		emailLabel.setFont(new Font("Arial", Font.PLAIN, 75));
		...
		submitBtn.setFont(new Font("Arial", Font.PLAIN, 40));
		...
		admin.setFont(new Font("Arial", Font.PLAIN, 40));
		...
		mainLabel2.setFont(new Font("Arial Black", Font.PLAIN, 40));
		...
		ans1Radio = new JRadioButton("Answer ");
		ans1Radio.setFont(new Font("Arial Black", Font.PLAIN, 25));
		ans1Radio.setBounds(20, 92, 534, 41);
		minor.add(ans1Radio);
		
		ans2Radio = new JRadioButton("");
		ans2Radio.setFont(new Font("Arial Black", Font.PLAIN, 20));
		ans2Radio.setBounds(20, 136, 534, 37);
		minor.add(ans2Radio);
		
		ans3Radio = new JRadioButton("");
		ans3Radio.setFont(new Font("Arial Black", Font.PLAIN, 20));
		ans3Radio.setBounds(20, 176, 534, 41);
		minor.add(ans3Radio);
		
		ans4Radio = new JRadioButton("");
		ans4Radio.setFont(new Font("Arial Black", Font.PLAIN, 20));
		...
		skipButton.setFont(new Font("Arial", Font.PLAIN, 15));
